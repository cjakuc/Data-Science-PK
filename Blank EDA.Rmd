...
reg.one=lm(freq~Population,data=Agencies2)
dplyr::summary(reg.one)

reg.two=lm(freq~Population+Poverty_Rate+Unemployment_Rate,data=Agencies2)
dplyr::summary(reg.two)

reg.three=lm(freq~Population+Poverty_Rate+Unemployment_Rate + Proportion_White + Proportion_Black,data=Agencies2)
dplyr::summary(reg.three)

reg.four=lm(freq~Population+Poverty_Rate+Unemployment_Rate + Proportion_White + med.tract.personal.inc,data=Agencies2)
dplyr::summary(reg.four)
