...
GunLaws1 <- gpops %>%
  mutate("Firearm Registration"=as.factor(gpops$`Firearm Registration`)) %>%
  mutate("Open Carry"=as.factor(gpops$`Open Carry`),
         "Open Carry Permit"=as.factor(gpops$`Open Carry Permit`),
         "Background Checks on Private Sales"=as.factor(gpops$`Background Checks on Private Sales`)) %>%
